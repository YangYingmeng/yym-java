 ...
 */
public class _003YymClassLoader extends ClassLoader {

    private static final String classPath = "_002Tuning/_02JVM/src/main/resources/testFile/Hello.class";
    private File file;
    public _003YymClassLoader(String sourcePath) {
        this.file = new File(sourcePath);
    }

    public _003YymClassLoader() {

    }
    public _003YymClassLoader(ClassLoader classLoader) {
        super(classLoader);
    }
    ...
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        _003YymClassLoader yymClassLoader = new _003YymClassLoader(classPath);
